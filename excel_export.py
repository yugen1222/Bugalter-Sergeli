...
def create_month_excel(rows: list[dict], year: int, month: int) -> Path:
    ...
    headers = [
        ...
        "Контрмеры", "Ответственный", "Комментарий",
        "Причина найдена", "Позиция", "Дата закрытия", "Как закрыли"
    ]
    ws.append(headers)
    ...
    widths = [13, 22, 12, 16, 14, 24, 12, 26, 42, 22, 40, 16, 14, 20, 35]
